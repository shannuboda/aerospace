        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcumb-inner">
                    ...
                    <h5 class="title">See our best Qualities</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="services-content">
                    <h3 class="title">Aerospace</h3>
                        ...
                        <div class="details">
                            <p>We delight Customers by supplying Products with consistent Quality and application of Zero Defect capable process and On Time Delivery through Continual Improvement.</p>
                        </div>
                        <br>
                        <br>

                    <h3 class="title">Inspection Facility</h3>
                        <div class="details">
                            <p>Inspection Facility comprises highly accurate Coordinate Measuring Machine which can measure job size of 4000 mm L x 2000 mm W x 1500 mm H with an accuracy of 4.7 microns per 1000 mm L. Backed by qualified inspectors & equiped with an array of measuring instruments and gauges we inspect prior to, during and after machining operations.</p>
                        </div>
                        <br>
                        <br>
                </div>
