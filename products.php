            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcumb-inner">
                        ...
                        <!-- <h5 class="title">See our professional Products</h5> -->
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="project-masonry-wrapper">
                    <div class="our-project-menu">
                        <ul>
                            ...
                            <li data-filter=".1">Aero Structure components </li>
                            <li data-filter=".2">Aero engine components </li>
                            <li data-filter=".3">Helicracfter components</li>
                            <li data-filter=".4">Missle components and System</li>
                            <li data-filter=".5">Submarines componentand its sub assembly</li>
                            <li data-filter=".6">Automobiles componentand its sub assembly</li>
                            <li data-filter=".7">Satillite components and its sub assembly</li>
                            <li data-filter=".8">Drones-Plant protection </li>
                            <li data-filter=".9">Precision components</li>
                        </ul>
                    </div>
                    <div class="project-masonry" id="project-masonry">
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 1">
                            <div class="inner-box">
                                <div class="image">
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 1">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/2.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Aero Structure components</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 2">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/3.jpg" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/3.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 2">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/5.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Aero engine components</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 2">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/6.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Aero engine components</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 3">
                            <div class="inner-box">
                                <div class="image">
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 4">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/8.jpg" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/8.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 4">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/9.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Missle components and System</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 5">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        ...
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Submarines componentand its sub assembly</h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size 5">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/12.jpg" class="imagepopup popup-link"  data-effect="zoomInUp">
                                             <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Submarines componentand its sub assembly</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item yg_filter_item_padding grid-size conditioner 6">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/13.jpg" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/13.jpg"  class="imagepopup popup-link"  data-effect="zoomInUp">
                                            <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Automobiles componentand its sub assembly</h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item grid-size yg_filter_item_padding 7">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/15.jpg" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/15.jpg"  class="imagepopup popup-link"  data-effect="zoomInUp">
                                            <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Satillite components and its sub assembly</h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item grid-size yg_filter_item_padding 7">
                            <div class="inner-box">
                                <div class="image">
                                    ...
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/16.jpg"  class="imagepopup popup-link"  data-effect="zoomInUp">
                                            <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Satillite components and its sub assembly</h4></a>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item grid-size yg_filter_item_padding 8">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/17.jpg" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/17.jpg"  class="imagepopup popup-link"  data-effect="zoomInUp">
                                            <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Drones-Plant Protection</h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 filtr-item grid-size yg_filter_item_padding remote 9">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="assets/img/products/18.png" alt="">
                                    <div class="img-overlay">
                                        <div class="icon"><a href="assets/img/products/18.png"  class="imagepopup popup-link"  data-effect="zoomInUp">
                                            <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content-area">
                                            <a href="#"><h4 class="title">Precision components</h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
